...
LABEL org.opencontainers.image.created="2026-08-18T19:00:46Z" \
      ...
      zzcollab.ppm.snapshot="2026-08-18" \
...
ENV LANG=en_US.UTF-8 LC_ALL=en_US.UTF-8 TZ=UTC \
    ...
    RENV_CONFIG_REPOS_OVERRIDE="https://packagemanager.posit.co/cran/__linux__/noble/2026-08-18" \
...
RUN echo 'options(repos = c(CRAN = "https://packagemanager.posit.co/cran/__linux__/noble/2026-08-18"))' \
